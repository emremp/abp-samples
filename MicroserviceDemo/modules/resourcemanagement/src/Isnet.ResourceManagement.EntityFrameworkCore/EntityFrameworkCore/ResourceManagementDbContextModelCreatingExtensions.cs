...
namespace Isnet.ResourceManagement.EntityFrameworkCore
{
    public static class ResourceManagementDbContextModelCreatingExtensions
    {
        public static void ConfigureResourceManagement(
            ...
            Action<ResourceManagementModelBuilderConfigurationOptions> optionsAction = null)
        {
            Check.NotNull(builder, nameof(builder));

            var options = new ResourceManagementModelBuilderConfigurationOptions(
                ResourceManagementDbProperties.DbTablePrefix,
